...
<header>
    <nav class="navbar">
        ...
        <article class="My Website">
            <a href="/boutique-en-ligne/index.php" 
            aria-label="Accéder à l'accueil du site"><h1>Cornail&Vernis</h1></a>
        </article>

        <article class="nav-link">
            <ul>
                <?php if (isset($_SESSION["username"])) : ?>
                    <li><a href="/boutique-en-ligne/views/user_update.php" 
                ...
                <?php else: ?>
                    <li class="connection"><a href="/boutique-en-ligne/views/user_login.php"
